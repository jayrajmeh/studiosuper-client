...
import Category_Edit from "./Balancebook_Edit";
import { Modal } from "react-bootstrap";
import moment from 'moment';



function BalancebookList() {
  ...
  const fetchData = async (page, limit, search) => {
    ...
    await ApiPost("/balancebook/get", body)
      .then((res) => {
        console.log("resData", res?.data);
        setData(res?.data?.data?.balancebook_count);
  ...
  return (
    <>
      <div className="d-flex justify-content-between mb-4">
        <div className="title">
          <div className="fs-20px fw-bolder">{lan.sidelist_balancebook}</div>
          <div>
            <span
              role="button"
      ...
      <div class="d-flex flex-column flex-column-fluid h-100" id="kt_content">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
              <h3 class="card-label">
              {lan.sidelist_balancebook} {lan.list}
              </h3>
            </div>
            <div class="card-toolbar">
              <a
                ...
                onClick={() => openModal()}
              >
                {lan.add} {lan.sidelist_balancebook}
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title id="example-modal-sizes-title-lg">
                {lan.delete} {lan.sidelist_balancebook}
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <span>
                {lan.are_you_sure} {lan.sidelist_balancebook}?
              </span>
            </Modal.Body>
            <Modal.Footer>
              <div>
...
export default BalancebookList;
